package sdk.addeals.ahead_solutions.sdk;

/**
 * Created by ArnOr on 01/05/2017.
 */

class AdManager {
        // Manage data. Never loaded again.
        public class AdManager : AbstractAdManager
        {
            ...
            internal static bool IsPopupOpening = false;
            public static bool SDKinitialized = false;
            public static Popup adPopup = null;

            // Demographics
            internal static Sex userSex = Sex.UNKNOWN;
            internal static int userAge = -1;
        ...
        public async static Task<bool> InitSDK(Panel layoutRoot, string appID, string appKey)
        {
            try
            {
                AppID = appID;
                ...
                if (!SDKinitialized || (SDKinitialized && lastLaunch.Add(new TimeSpan(0, 12, 0, 0)) < DateTime.UtcNow)
                        || !(bool)ApplicationData.Current.LocalSettings.Values[AbstractSettingsHelperSDK.AS20082013INSTALL_NOTIFIED])
                {
        ...
        /// </summary>
        internal static string GetWallWebLink()
        {
        ...
        /*public async static Task<bool> CacheAd(Panel mainPageLayout, AdManager.AdKind adKindSupported)
        {
        ...
        public async static Task<bool> IsVideoAvailable(Panel mainPageLayout, AdManager.AdKind adKindSupported)
        {
            if (adDealsSquare == null)
            {
                await GetPopupAd(mainPageLayout, adKindSupported);
        ...
        /*public static bool IsPopupAdOpen()
        {
            if (adDealsSquare != null)
        ...
        public static bool IsWallAdOpen()
        {
            if (adDealsWall != null)
        ...
        public static bool IsAdPopupOpen()
        {
            if (adPopup != null)
            {
        ...
        internal static void ResetAdDealsSquare()
        {
            //adDealsSquare = null;
        }

        // Only 1 interstitial can be opened at a time from the AdManager.
        internal static void ResetAdDealsWall()
        {
            adDealsWall = null;
        }

        /*internal static AdDealsPopupAd GetAdDealsSquare()
        {
        ...
        {
            if (!(bool)ApplicationData.Current.LocalSettings.Values[AbstractSettingsHelperSDK.AS20082013INSTALL_NOTIFIED])
            {
        ...
        /*internal static AdDealsPopupAdViewModel AdDealsPopupAdViewModel
        {
            get
            {
        ...
        internal static AdDealsPopupAdViewModel GetPopupViewModel(AdKind adkind)
        {
            switch (adkind)
            {
                case AdKind.REWARDEDVIDEOAD:
        ...
        internal static AdDealsPopupAd GetAdDealsSquare(AdKind adkind)
        {
            switch (adkind)
            {
                case AdKind.REWARDEDVIDEOAD:
        ...
        /// </summary>
        /// <returns>The SquareViewModel object.</returns>
        internal static AdDealsWallViewModel AdDealsWallViewModel
        {
            get
            {
                // Delay creation of the view model until necessary
        ...
        private static bool _disableHeaderWebLink = false;
        public static bool DisableHeaderWebLink
        {
            get
            {
        ...
        public static DeviceType DeviceKind
        {
            get
            {
                return _deviceKind;
        ...
        internal static async void OpenMarketPlace(string webLink)
        {
            try
            {
